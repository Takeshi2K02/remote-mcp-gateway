"""
Shared translation of raw SQL connection errors into distinct,
...
(login timeout, connection reset, auth failure, etc.) is always
...
def classify_sql_connection_error(
    ...
    """Translate a raw SQLAlchemy/pyodbc error into a distinct
